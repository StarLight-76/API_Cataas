...
_Текст для картинки_

_Токен с Полигона Яндекс.Диска. Важно: Токен публиковать в github не нужно!_
### Выходные данные: ###
json-файл с информацией по загруженным файлам
Измененный Я.диск, куда добавились фотографии

# Использование #
1. Пользователь вводит свой токен Яндекс.Диск.
2. Пользователь вводит текст - название файла.
